        ...
        <footer className="bg-accent border-t">
            <div className="container px-4 md:px-6 py-12">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    <div className="space-y-4">
                        ...
                        <p className="text-sm text-muted-foreground">
                            Revolutionizing hiring in India with AI-powered interviews and smart candidate matching.
                        </p>
                    ...
                    <div>
                        <h3 className="text-sm font-semibold mb-3">For Job Seekers</h3>
                        <ul className="space-y-2 text-sm">
                            <li><a href="#" className="text-muted-foreground hover:text-primary transition-colors">Browse Jobs</a></li>
                            <li><a href="#" className="text-muted-foreground hover:text-primary transition-colors">Interview Preparation</a></li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm">
                            ...
                            <li><a href="#" className="text-muted-foreground hover:text-primary transition-colors">AI Interview Setup</a></li>
                ...
                <div className="border-t mt-8 pt-8 flex flex-col md:flex-row justify-between">
                    <p className="text-sm text-muted-foreground">
                        &copy; {new Date().getFullYear()} JobsIndiaAI. All rights reserved.
                    </p>
